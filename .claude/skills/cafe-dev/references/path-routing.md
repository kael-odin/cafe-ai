...
| `src/main/platform/event/` | `platform-layer.md`, `integration-contracts.md` | `src/main/platform/event/index.ts`, `src/main/platform/event/event-bus.ts`, `src/main/platform/event/sources/*.ts` |
