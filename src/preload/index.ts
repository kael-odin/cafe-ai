...
export interface CafeAPI {
  ...
  // Space
  getCafeSpace: () => Promise<IpcResponse>
...
const api: CafeAPI = {
  ...
  // Space
  getCafeSpace: () => ipcRenderer.invoke('space:get-Cafe'),
...
contextBridge.exposeInMainWorld('Cafe', api)
...
// TypeScript declaration for window.Cafe and window.platform
declare global {
  interface Window {
    Cafe: CafeAPI
    platform: {
