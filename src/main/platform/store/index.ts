...
const APP_DB_FILENAME = 'cafe.db'

/**
 * Initialize the platform store module.
 *
 * Creates and returns a DatabaseManager configured for the Cafe data directory.
 * The app-level database is located at `{cafeDir}/cafe.db`.
 *
