...
export function AppChatView({ appId, spaceId }: AppChatViewProps): JSX.Element {
  ...
  const handleSend = useCallback(async (content: string, images?: ImageAttachment[], _files?: unknown, thinkingEnabled?: boolean) => {
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="shrink-0 p-4">
          ...
          <InputArea
            ...
            onSend={(content, images, files, thinkingEnabled) => { void handleSend(content, images, files, thinkingEnabled) }}
