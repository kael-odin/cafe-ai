 ...
 *
 * Shows all saved Cafe desktop servers. The user can:
    ...
    <div className="relative overflow-hidden rounded-xl">
      ...
      >
        ...
        <div className="flex-shrink-0 flex items-center gap-1.5">
          ...
          {status === 'online' && (
            <>
              <Wifi className="w-4 h-4 text-cafe-success" />
              <span className="text-xs text-cafe-success">{t('Online')}</span>
            </>
          )}
          {status === 'offline' && (
            <>
        ...
        {servers.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1 max-w-[260px]">
              {t('Add your first Cafe desktop to get started')}
            </p>
          </div>
        )}
      </div>
